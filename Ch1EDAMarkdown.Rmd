...
usoc %>%
  ...
  labs(title = "Proportion of Parents Using Childcare by Work Type", subtitle = "-8 - Non-Working, 1 - FT, 2 - PT")
...
From the right-hand chart we can see the evolution of childcare utilisation for the three categories over time. Non-working parents levels are flat over the period with minimal volatility. Standard errors for the trend are muted over the period. Full-time workers (green) exhibit a somewhat upward trend, although looking at the overall levels it doesn't appear too pronounced and this is mirrored by a decline in part-time childcare utilisation over the period. 
